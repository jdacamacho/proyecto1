...
public class factoryPP_AImpl implements factoryPP_AInt {
    ...
    public PropuestaTrabajoGradoPP_A crearPP_A(Usuario director, Usuario estudiante, Usuario codirector,
        ...
        PropuestaTrabajoGradoPP_A propuesta = new PropuestaTrabajoGradoPP_A(director, estudiante,codirector, asesor, titulo, subido,rutaPropuesta,revisioncomitepp_a);
        return propuesta;
    }
