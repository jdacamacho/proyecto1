...
@Service
public class RevisionComiteFormateadorResultadosTI_AImpl implements RevisionComiteFormateadorResultadosTI_AInt {
    
    private final ModelMapper revisionComiteMapeador;
    
    public RevisionComiteFormateadorResultadosTI_AImpl(ModelMapper revisionComiteMapeador){
